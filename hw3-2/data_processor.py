...
class DataProcessor():
	def __init__(self, image_num=180):
		# Constant Parameters
		self.image_num = image_num
		self.image_path = './AnimeDataset/extra_data/'
		self.img_npy_path = './AnimeDataset/extra_faces.npy'
		self.tag_path = './AnimeDataset/extra_data/tags.csv'
		self.label_npy_path = '.AnimeDatset/tags.npy'
